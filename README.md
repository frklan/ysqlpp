...
A C++20 wrapper for SQLlite3.

Probably more inspired from msqlite than is healthy. Perhaps it's a copy?

**Note** This code is probably full of bugs and UB. Don't run it in production!

## Compiling

```bash
cmake .. -DENABLE_FUZZING=OFF -DENABLE_TESTING=OFF -DWARNINGS_AS_ERRORS=OFF -DENABLE_DOXYGEN=OfF  -DCMAKE_BUILD_TYPE=RelWithDebInfo  -DENABLE_CACHE=ON -DENABLE_CPPCHECK=ON -DENABLE_CLANG_TIDY=ON -DENABLE_INCLUDE_WHAT_YOU_USE=OFF -G Ninja
